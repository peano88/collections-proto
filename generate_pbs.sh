...
# Cpp
protoc -I $PROTOS_PATH --grpc_out=cpp/build --plugin=protoc-gen-grpc=`which grpc_cpp_plugin` $ITEM_PROTO_FILE
protoc -I $PROTOS_PATH --cpp_out=cpp/build $ITEM_PROTO_FILE
protoc -I $PROTOS_PATH --grpc_out=cpp/build --plugin=protoc-gen-grpc=`which grpc_cpp_plugin` $COLL_PROTO_FILE
